...
class AccountDropdown extends PositionComponent
            ...
            if (game.buildContext != null) {
              showAuthDialog(
                ...
                onSubmit: (email, pass, username) async {
                  ...
                  if (updatedUser != null) {
                    String labelText =
                        updatedUser.displayName ?? updatedUser.email ?? 'User';
                    _updateLabel(labelText);
                  }
                },
              );
            ...
            children: [
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Text(
                    "Single: $singleGames | Multi: $multiGames",
