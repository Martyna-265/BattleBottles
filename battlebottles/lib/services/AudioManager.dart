...
class AudioManager {
  ...
  static Future<void> init() async {
    ...
    try {
      ...
      _splashPool = await FlameAudio.createPool(
        'splash.wav',
        minPlayers: 1,
        maxPlayers: 3,
      );

      _startPool = await FlameAudio.createPool(
        'start.wav',
        minPlayers: 1,
        maxPlayers: 1,
      );
      ...
      _monsterPool = await FlameAudio.createPool(
        'monster.wav',
        minPlayers: 1,
        maxPlayers: 2,
      );
      _sinkPool = await FlameAudio.createPool(
        'sink.wav',
        minPlayers: 1,
        maxPlayers: 2,
      );
